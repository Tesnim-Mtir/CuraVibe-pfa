                                    ...
                                    <tbody>
                                        @foreach ($medicament as $index => $m)
                                            <tr>
                                                ...
                                                <td>{{ $m->VEIC }}</td>
                                                <td>
                                                    <a data-bs-toggle="modal" data-bs-target="#editMedicament{{ $m->id }}" class="btn btn-success">Modifier</a>
                                                    <a onclick="return confirm('voulez-vous vraiment supprimer ce medicaments?')" href="/admin/medicament/{{ $m->id }}/delete" class="btn btn-danger">Supprimer</a>
...
@foreach ($medicament as $index=>$m )
        <!--Modal update-->
    <div class="modal fade" id="editMedicament{{ $m->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"
        style="display: none;">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
