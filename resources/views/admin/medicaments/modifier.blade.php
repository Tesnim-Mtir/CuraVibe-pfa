          ...
          <div class="pb-5">
            <div class="row g-5">
                <div>
                 ...
                 @endif 
                  <a data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary mt-3">Ajouter medicament</a>
              ...
              <form action="/admin/medicament/update/{{ $medicament->id }}" method="post">
                @csrf
                @method('PUT')
                <div class="mb-3">
                  <label class="form-label" for="exampleFormControlInput1">Nom</label>
                  <input name="Nom" class="form-control" id="exampleFormControlInput1" type="text" value="{{ $medicament->Nom }}">
                </div>
                <!-- Ajoutez les autres champs avec les valeurs actuelles du médicament -->
          ...
          <footer class="footer">
            <div class="row g-0 justify-content-between align-items-center h-100 mb-3">
              <div class="col-12 col-sm-auto text-center">
                <p class="mb-0 text-900">Thank you for joining Curavibe community<span class="d-none d-sm-inline-block"></span><span class="mx-1">|</span><br class="d-sm-none">2024 &copy; <a href="https://themewagon.com">Themewagon</a></p>
              </div>
              <div class="col-12 col-sm-auto text-center">
...
<input name="Nom" class="form-control" id="exampleFormControlInput1" type="text" placeholder="taper nom medciament"></div>
                      
<div class="mb-3"><label class="form-label" for="exampleFormControlInput2">Dosage</label>
  <input name="Dosage" class="form-control" id="exampleFormControlInput2" type="text" placeholder="taper dosage"></div>
                        
<div class="mb-3"><label class="form-label" for="exampleFormControlInput3">Forme</label> 
    <input name="Forme" class="form-control" id="exampleFormControlInput3" type="text" placeholder="taper forme"></div>

 <div class="mb-3"><label class="form-label" for="exampleFormControlInput4">Présentation</label> 
 <input name="Présentation" class="form-control" id="exampleFormControlInput4" type="text" placeholder="taper presentation"></div>

 <div class="mb-3"><label class="form-label" for="exampleFormControlInput5">DCI</label> 
<input name="DCI" class="form-control" id="exampleFormControlInput5" type="text" placeholder="taper DCI"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput6">Classe</label> 
<input name="Classe" class="form-control" id="exampleFormControlInput6" type="text" placeholder="taper classe"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput7">Sous Classe</label> 
<input name="Sous_Classe" class="form-control" id="exampleFormControlInput7" type="text" placeholder="taper nom medciament"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput8">Laboratoire</label> 
 <input name="Laboratoire" class="form-control" id="exampleFormControlInput8" type="text" placeholder="taper nom laboratoir"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput9">AMM</label> 
<input name="AMM" class="form-control" id="exampleFormControlInput9" type="text" placeholder="taper nom medciament"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput10">Date AMM</label> 
<input name="Date_AMM" class="form-control" id="exampleFormControlInput10" type="text" placeholder="taper AMM"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput11">Conditionnement primaire</label> 
 <input name="Conditionnement_primaire" class="form-control" id="exampleFormControlInput11" type="text" placeholder="taper les conditionnements primairs"></div>

 <div class="mb-3"><label class="form-label" for="exampleFormControlInput12">Spécifocation Conditionnement primaire</label> 
<input name="Spécifocation_Conditionnement_primaire" class="form-control" id="exampleFormControlInput12" type="text" placeholder="taper spécification primaire"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput13">tableau</label> 
<input name="tableau" class="form-control" id="exampleFormControlInput13" type="text" placeholder="taper tableau"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput14">Durée de conservation</label> 
  <input name="Durée_de_conservation" class="form-control" id="exampleFormControlInput14" type="number" placeholder="entrer la durée de consevation"></div>

     <div class="mb-3"><label class="form-label" for="exampleFormControlInput15">Indications</label> 
    <input name="Indications" class="form-control" id="exampleFormControlInput15" type="text" placeholder="taper les indications"></div>

       <div class="mb-3"><label class="form-label" for="exampleFormControlInput16">G/P/B</label> 
       <input name="G_P_B" class="form-control" id="exampleFormControlInput16" type="text" placeholder="taper g/p/b"></div>

        <div class="mb-3"><label class="form-label" for="exampleFormControlInput17">VEIC</label> 
        <input name="VEIC" class="form-control" id="exampleFormControlInput17" type="text" placeholder="taper veic"></div>
