...
<head>
    ...
    <style>
        ...
        .ffbox1 {
            width: 50%;
            /* Demi largeur pour le formulaire */
            height: 400px;
        ...
        .submit-button {
            border-radius: 15px;
            /* Conservez les coins arrondis */
            padding: 8px 20px;
            /* Ajustez le rembourrage du bouton pour correspondre à la taille du formulaire */
            ...
            /* Transition douce pour le changement de couleur au survol */
        }
                ...
                <ul>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                            data-toggle="dropdown">Recycle</a>
    ...
    <div class="ffbox">
        <div class="ffbox1">
            <div class="bg-light rounded h-100 p-4">
                <h6 class="mb-4">Pharmacies</h6>
                @if ($pharmacies->isEmpty())
                    <p>Aucune pharmacie n'a été trouvée dans cette ville.</p>
                @else
                    <table class="table">
                        <thead>
                            <tr>
