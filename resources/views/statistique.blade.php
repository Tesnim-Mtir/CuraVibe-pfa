      ...
      <div class="container-fluid px-0">
        ...
        <div class="content">
          <div class="pb-5">
            <div class="row g-5">
                <div>
<a data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-primary">Ajouter medicament</a>
                </div>
...
<div class="mb-3"><label class="form-label" for="exampleFormControlInput3">Forme</label> 
 ...
 <input name="presentation" class="form-control" id="exampleFormControlInput4" type="text" placeholder="taper presentation"></div>
...
<input name="sous-classe" class="form-control" id="exampleFormControlInput7" type="text" placeholder="taper nom medciament"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput8">Laboratoire</label> 
 <input name="labo" class="form-control" id="exampleFormControlInput8" type="text" placeholder="taper nom laboratoir"></div>
...
<input name="dateamm" class="form-control" id="exampleFormControlInput10" type="text" placeholder="taper AMM"></div>

<div class="mb-3"><label class="form-label" for="exampleFormControlInput11">Conditionnement primaire</label> 
 <input name="cp" class="form-control" id="exampleFormControlInput11" type="text" placeholder="taper les conditionnements primairs"></div>

 <div class="mb-3"><label class="form-label" for="exampleFormControlInput12">Spécifocation Conditionnement primaire</label> 
<input name="specification" class="form-control" id="exampleFormControlInput12" type="text" placeholder="taper spécification primaire"></div>
...
<div class="mb-3"><label class="form-label" for="exampleFormControlInput14">Durée de conservation</label> 
  <input name="duree" class="form-control" id="exampleFormControlInput14" type="number" placeholder="entrer la durée de consevation"></div>
    ...
    <input name="indications" class="form-control" id="exampleFormControlInput15" type="text" placeholder="taper les indications"></div>
       ...
       <input name="gpb" class="form-control" id="exampleFormControlInput16" type="text" placeholder="taper g/p/b"></div>
